...
class MainServer {
    ...
    setupRoutes() {
        ...
        this.app.use('/api/dashboard', authMiddleware.requireAuth, dashboardRoutes);
        this.app.use('/api/admin', authMiddleware.requireAuth, adminMiddleware.requireAdmin, adminRoutes);
        this.app.use('/api/payments', authMiddleware.requireAuth, paymentRoutes);
        this.app.use('/api/tickets', authMiddleware.requireAuth, ticketRoutes);
        this.app.use('/api/analytics', authMiddleware.requireAuth, analyticsRoutes);
        this.app.use('/api/verification', authMiddleware.requireAuth, verificationRoutes);
